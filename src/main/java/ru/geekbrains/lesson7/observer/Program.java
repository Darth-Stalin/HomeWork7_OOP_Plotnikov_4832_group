...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        Vacancy designer = Vacancy.дизайнер;
        Vacancy animator = Vacancy.мультипликатор;
        Vacancy screenwriter = Vacancy.сценарист;

        Company google = new Company("Google", jobAgency, 120000, designer);
        Company yandex = new Company("Yandex", jobAgency, 95000, animator);
        Company geekBrains = new Company("GeekBrains", jobAgency, 98000, screenwriter);
